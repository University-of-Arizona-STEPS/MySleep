...
<html style="background-image: url('assets/img/bkg-lg.jpg');">
	...
	<title>MySleep // Turn On/Off Diary Computation</title>
    </head>
	...
	<div class="wrapper">
		...
		<div class="container">
			...
			<div class="col-xs-offset-1 col-xs-10 col-sm-10">
				...
				<li class="active">Turn On/Off Diary Computation</li>
                            </ol>
			</div>
                    </div>
		</div>
		...
		<form data-form-location="set-reminder-status-done" data-success-message="" data-error-message="" enctype="multipart/form-data" method="post">
			...
			<table class="table table-striped">
			    ...
			    <tbody>
				<tr>
				    <td>Diary Computation</td>
				    <td>
					<div class="togglebutton">
					    <label>
						<input type="checkbox" id="diary-computation-checkbox" name="diary-computation-checkbox" <?php echo ($diaryComputation== 1 ? 'checked' : '0');?>>
					    </label>
					</div>
				    </td>
				</tr>
    ...
    <script>
     $(function () {
         $('form').on('submit', function (e) {
             ...
             $.ajax({
		 type: 'post',
		 url: 'set-diary-computation-done',
		 data: $('form').serialize(),
		 success: function () {
