...
$result = mysql_query("SELECT * FROM fourthGradeLessonOneWhatSleep WHERE resultRow = '$myResultRow'");
...
if ($numRow>0) {
      ...
      $status = mysql_query("UPDATE fourthGradeLessonOneWhatSleep SET agree='$agree', disagree='$disagree' WHERE resultRow = '$myResultRow'");
      if (!$status) {
