...
<html style="background-image: url('assets/img/bkg-lg.jpg');">
    ...
    <head>
        ...
        <title>MySleep // Story Three</title>
    </head>
        ...
        <div class="wrapper">
            <div class="main main-raised">
				...
				<li><a href="#" onclick="location.href='fifth-grade-lesson-activity-menu?lesson=1&activity=2'">Activity Two</a></li>
                                ...
                                <li class="active">Story Three</li>
                            </ol>
                        </div>
                    </div>
                    <?php } ?>
			...
			<div class="col-md-8 col-md-offset-2">
				...
				<div class="content">
					...
					<div class="tab-pane active" id="one">
						...
						<div style="column-count:2;margin-bottom:2em;">
						    ...
						    <p>The space shuttle Challenger exploded shortly after it left the launching pad today and disintegrated over the Atlantic Ocean off the coast of Cape Canaveral, Florida around 11:30 a.m. Cameras equipped with telescopic lenses captured the explosion. At the news conference, a NASA spokesman would not speculate on the cause of the disaster.</p>
                                                </div>
                                            </div>
              ...
              <button id="play" class="btn btn-primary btn-round" style="display:none;"><i class="fa fa-play-circle" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;Play Audio</button>
					...
					<!--<div class="tab-pane text-center" id="three">
					    <video style="width:100%;" src="./videos/tablet3_3.mp4" controls style="min-width:100%;"></video>
					</div>-->
					<div class="tab-pane" id="three">
						...
						<div style="column-count:2;margin-bottom:2em;">
						    ...
						    <p>The Presidential Commission on the Space Shuttle Challenger accident concluded that the cause of the accident was the failure of O-rings in a solid rocket booster. The O-ring failure caused the solid rocket booster joint seal to break, allowing pressurized burning gas from within the solid rocket motor to reach the outside external fuel tank. The O-rings were not designed for use at low temperatures. Human error was involved in deciding to go ahead with the launch under the unusual freezing conditions. Senior managers who made the decision had been working irregular hours and experienced a loss of sleep. The Commission noted that reluctance to contradict superiors and NASA work schedules contributed to poor decision-making.</p>
                                                </div>
                                            </div>
