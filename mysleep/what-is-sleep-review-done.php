  ...
  <body>
        ...
        <div class="main main-raised">
                ...
                $resultRow = explode(',',ltrim($_POST['records'], ','));
        		    ...
        		    /*				Save to MySQL        */
        		    /*-----------------------------------------------*/
                $update_query = "UPDATE fourthGradeLessonOneWhatSleep SET ";
    		    ...
    		    <div class="row top">
                    ...
                    <a class="btn btn-gradbg btn-large btn-block"  name="Continue" href="what-is-sleep-non-student-review<?php echo "?".$query; ?>">Continue</a>
          			</div>
    		    </div>
    		</div>
    	    </div>
