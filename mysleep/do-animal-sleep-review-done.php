  ...
  <body>
        ...
        <div class="main main-raised">
                ...
                $resultRow = explode(',',ltrim($_POST['records'], ','));
        		    ...
        		    /*				Save to MySQL        */
        		    /*-----------------------------------------------*/
                $update_query = "UPDATE fourthGradeLessonDoAnimalSleep SET ";
    		    ...
    		    <div class="row top">
                    ...
                    <a class="btn btn-gradbg btn-large btn-block"  name="Continue" href="do-animal-sleep-non-student-review<?php echo "?".$query; ?>">Continue</a>
          			</div>
    		    </div>
    		</div>
    	    </div>
