...
<html>
	...
	<div class="wrapper" >
		...
		<div class="container">
			...
			<li class="active">Bundle Create Student Accounts</li>
		    </ol>
			...
			<h4 class="description">
				...
				$accountFile=$_FILES['createStudentAccounts'];
				...
				if($userType == 'researcher'){
					...
					echo "Please select teacher's school";
					echo "</br>"; 
				...
				for($i = 0; $i<count($userName); $i++){
					...
					$status = mysql_query("INSERT INTO user_table(`firstName`, `lastName`, `userName`, `password`, `currentGrade`, `emailAddress`, `type`, `classId`, `schoolId`, `firstId`, `secondId`) VALUES ('$sFirstName','$sLastName','$sUserName','$encryptedPassword', '$classGrade', '$sEmailAddress', '$user_type','$classId', '$schoolId', '$sFirstId', '$sSecondId')"); 
					...
					mysql_query("INSERT INTO class_tracking_table (userId, classId) VALUES ('$lastInsertId', '$classId')"); // Add Student to current class
