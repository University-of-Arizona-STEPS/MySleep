                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="row">
	                                  ...
	                                  <h4>What is Sleep?<br><small>Please type your answer below.</small></h4>
																		<?php include 'add-group-member-button.php' ?>
	                                  <textarea name="whatIsSleep" id="whatIsSleep" class="form-control" rows="10"><?php echo htmlspecialchars($content);?></textarea>
																</div>
                            </div>
