...
<body>
    ...
    <div class="wrapper">
                ...
                <div class="row">
                    <div class="col-xs-offset-1 col-xs-10 col-sm-10">
                        <ol class="breadcrumb">
                            ...
                            <li class="active">Set Sleep Dairy Date</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <form action="set-diary-date-done" id="dateForm"  enctype="multipart/form-data" method="post">
        ...
        foreach ($resultLink as $studentId){
					...
					if($grade == 4){
						$diaryStartDate = $row['diaryStartDateFour'];
						$diaryEndDate = $row['diaryEndDateFour'];
					}else{
						$diaryStartDate = $row['diaryStartDateFive'];
						$diaryEndDate = $row['diaryEndDateFive'];
					}
